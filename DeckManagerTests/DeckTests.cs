...
namespace DeckManagerTests
{
    ...
    public class DeckTests
    {
        ...
        {
            var constructedDeck = new SuperCrisisDeck(null, @"..\..\TestContent\SuperCrisisDeck.json");
        ...
        {
            var constructedDeck = new QuorumDeck(null, @"..\..\TestContent\QuorumDeck.json");
        ...
        {
            var constructedDeck = new CrisisDeck(null, @"..\..\TestContent\DestinationDeck.json");
        ...
        {
            var constructedDeck = new CrisisDeck(null, @"..\..\TestContent\Crisis.json");
        ...
        {
            var constructedDeck = new SkillCardDeck(null, SkillCardColor.Engineering, @"..\..\TestContent\EngineeringDeck.json");
        ...
        {
            var constructedDeck = new SkillCardDeck(null, SkillCardColor.Leadership, @"..\..\TestContent\EngineeringDeck.json");
            Assert.AreEqual(constructedDeck.Deck.Count, 21);
        }
        ...
        {
            var constructedDeck = new SkillCardDeck(null, SkillCardColor.Politics, @"..\..\TestContent\EngineeringDeck.json");
            Assert.AreEqual(constructedDeck.Deck.Count, 21);
        }
        ...
        {
            var constructedDeck = new SkillCardDeck(null, SkillCardColor.Piloting, @"..\..\TestContent\EngineeringDeck.json");
            Assert.AreEqual(constructedDeck.Deck.Count, 21);
        }
        ...
        {
            var constructedDeck = new SkillCardDeck(null, SkillCardColor.Tactics, @"..\..\TestContent\EngineeringDeck.json");
            Assert.AreEqual(constructedDeck.Deck.Count, 21);
        }
    }
}
